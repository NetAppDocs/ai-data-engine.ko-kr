...
.시작하기 전에
* 기존 AFX 1K 스토리지 시스템이 설치되어 있습니다. AFX 1K 스토리지 시스템 설치에 대한 자세한 내용은 link:https://docs.netapp.com/us-en/ontap-afx/install-setup/install-setup-workflow.html["AFX 1K 스토리지 시스템을 설치합니다"^]을 참조하십시오.
...
.다음 단계
hardware를 케이블로 연결한 후 link:power-on-hardware.html["Data Compute Node의 전원을 켜세요"].
